...
0.0002524        VS_Rgn2K    - Generator torque constant in Region 2 for simple variable-speed generator control (HSS side) (N-m/rpm^2) [used only when VSContrl=1]
...
1                SIG_SlPc    - Rated generator slip percentage (%%) [used only when VSContrl=0 and GenModel=1]
...
"NRT_Tower.dat"  TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"NRT_Blade1_as_built_balanced.dat" BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"NRT_Blade2_as_built_balanced.dat" BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"NRT_Blade3_as_built_balanced.dat" BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"NRT_AD.ipt"     ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
