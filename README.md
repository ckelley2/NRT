...
- Blade bending moment coefficients to achieve scaled wake (at reference air density of 1.078 kg/m^3) are as follows for discreet strain gage locations in thrust and edge directions
- Wake Management demonstration showing a combination of yaw, induction, and [dynamic induction control](https://arc.aiaa.org/doi/abs/10.2514/6.2021-1182)
